...
from multi_agent_sync.evaluation.benchmarks import chess, gpqa, gsm8k, hpqa as hotpotqa, ma_proofbench, mmlu_pro, olymmath

sys.modules[__name__ + ".chess"] = chess
sys.modules[__name__ + ".gpqa"] = gpqa
sys.modules[__name__ + ".gsm8k"] = gsm8k
sys.modules[__name__ + ".hotpotqa"] = hotpotqa
