...
from multi_agent_sync.graph.nodes import orchestrator_node, run_multi_agent_runtime_node, synthesizer_node
...
def build_workflow():
    ...
    graph.add_edge("orchestrator", "run_multi_agent_runtime")
...
async def run_workflow(
    ...
    total_runtime_timeout: float = 90.0,
